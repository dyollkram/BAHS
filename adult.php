                    ...
                    <form action="" name="adultform" method="POST">
                        ...
                        <div class="form-group">
                            <label for="mi">Middle Initial:</label>
                                <input type="text" class="form-control" id="MiddleInitial" placeholder="Enter Middle Initial" name="middleinitial">
                        </div><div class="form-group">
                            <label for="age">Age:</label>
                                <input type="text" class="form-control" id="Age" placeholder="Enter Age" name="age">
                        </div><div class="form-group">
                            <label for="bday">Birthday:</label>
                                <input type="text" class="form-control" id="Birthday" placeholder="Enter Birthday Y-M-D" name="birthday">
                        </div><div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="street">StreetAddress:</label>
                                <input type="text" class="form-control" id="StreetAddress" placeholder="Enter StreetAddress" name="streetaddress">
                        </div>
                        <div class="form-group">
                            <label for="barangay">Barangay Address:</label>
                                <input type="text" class="form-control" id="BarangayAddress" placeholder="Enter Barangay Address" name="barangayaddress">
                        </div>
                        <div class="form-group">
                            <label for="municipality">Municipality Address:</label>
                                <input type="text" class="form-control" id="MunicipalityAddress" placeholder="Enter Municipality Address" name="municipalityaddress">
                        </div>
                        <div class="form-group">
                            <label for="medical">Medical Status:</label>
                                <input type="text" class="form-control" id="Medicalstatus" placeholder="Enter Medical Status" name="medicalstatus">
                        </div>
                        <div class="form-group">
                            <label for="bhw">BHW Assigned:</label>
                                <input type="text" class="form-control" id="BHWassigned" placeholder="Enter BHW Assigned" name="bhwassigned">
                        </div>
                        <div class="form-group">
                            <label for="philhealthnum">Philhealth #:</label>
                                <input type="text" class="form-control" id="Philhealthnumber" placeholder="Enter Philhealth #" name="philhealthnumber">
                        </div>
                        <div class="form-group">
                            <label for="philhealthstat">Philhealth Status:</label>
                                <input type="text" class="form-control" id="Philhealthstatus" placeholder="Enter Philhealth Status" name="philhealthstatus">
                        </div>
                        <div class="form-group">
                            <label for="philhealthmem">Philhealth Member:</label>
                                <input type="text" class="form-control" id="Philhealthmember" placeholder="Enter Philhealth Member" name="philhealthmember">
                        </div>
                        <div class="form-group">
                            <label for="head">Head of Family:</label>
                                <input type="text" class="form-control" id="HeadofFamily" placeholder="Enter Head of Family" name="headoffamily">
                        </div>
                        <div class="form-group">
                            <label for="referral">Referral Status:</label>
                                <input type="text" class="form-control" id="Referralstatus" placeholder="Enter Referral Status" name="referralstatus">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="ttstatus">T.T Status:</label>
                                <input type="text" class="form-control" id="T.TStatus" placeholder="Enter T.T Status" name="ttstatus">
                        </div>
                        <div class="form-group">
                            <label for="mother">Mothername:</label>
                                <input type="text" class="form-control" id="Mothername" placeholder="Enter Mothername" name="mothername"> <!-- ADULT ITR JOIN -->
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="pod">Place of Delivery:</label>
                                <input type="text" class="form-control" id="PlaceofDelivery" placeholder="Enter Place of Delivery" name="placeofdelivery">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="bo">Birth Order:</label>
                                <input type="text" class="form-control" id="BirthOrder" placeholder="Enter Birth Order Y-M-D" name="birthorder">
                        </div>
                        <div class="form-group">
                            <label for="breastfed">Breastfed:</label>
                                <input type="text" class="form-control" id="Breastfed" placeholder="Enter Breastfed" name="breastfed">
                        </div>
                        <div class="form-group">
                            <label for="mixed">Mixed Status:</label>
                                <input type="text" class="form-control" id="MixedStatus" placeholder="Enter Mixed Status" name="mixedstatus">
                        </div>
                        <div class="form-group">
                            <label for="datenbs">Date of NBS:</label>
                                <input type="text" class="form-control" id="DateofNBS" placeholder="Enter Date of NBS Y-M-D" name="dateofnbs">
                        </div>
                            <div class="checkbox">
                                        ...
                                        if(isset($_POST["insert"]))
                                        {
                                            ...
                                            $dateofnbs= $_POST['dateofnbs'];
                                                ...
                                                VALUES('$lastname','$firstname','$middleinitial','$age','$birthday','$gender','$contact','$streetaddress',
                                                    ...
                                                    if($query)
                                                    {
                                                        $sql2 = "INSERT INTO child_itr (child_mothername,child_fathername,child_placedelivery,child_attendedby,child_birthorder,child_breastfed,child_mixed,child_dateofnbs) 
                                                        VALUES ('$mothername','$fathername','$placeofdelivery','$attendedby','$birthorder','$breastfed','$mixedstatus','$dateofnbs')";
